...
def main():
    while True:
        ...
        cat_image = "C:\\Users\\alias\\Downloads\\cat-disgust.jpeg"
        if face_landmark_points:
            face_landmark_points = face_landmark_points[0]
            if cat_tongue(face_landmark_points):
                cat_image = "C:\\Users\\alias\\Downloads\\cat-tongue.jpeg"
            elif cat_shock(face_landmark_points):
                cat_image = "C:\\Users\\alias\\Downloads\\cat-shock.jpeg"
            elif cat_glare(face_landmark_points):
                cat_image = "C:\\Users\\alias\\Downloads\\cat-glare.jpeg"
            else:
                cat_image = "C:\\Users\\alias\\Downloads\\larry.jpeg"
